...
order: 1
summary: "A live coding tour of advanced debugger features in IntelliJ IDEA, from lambda breakpoints to custom data renderers."
videoUrl: "https://www.youtube.com/watch?v=uRpWrcoL4Ws"
tags: ["java", "intellij idea", "debugging", "live-coding"]
---

Most developers use breakpoints to pause execution on a line. That's about 10% of what the breakpoint system in IntelliJ IDEA can do. This session covers the other 90%.
I systematically work through every breakpoint type and configuration option:
